...
def init_mcore_model(
    ...
    **extra_kwargs,  # may be used for vlm and moe
    ...
    return initializer.initialize(pre_process=pre_process, post_process=post_process, pp_layers=pp_layers, share_embeddings_and_output_weights=share_embeddings_and_output_weights, value=value, **extra_kwargs)
