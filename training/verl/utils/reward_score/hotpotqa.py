import re
EXTRACTION_TEMPLATE = """
Look at the following question and an answer, your job is to EXTRACT the final answer from the following answer string.
...
If the given answer string is not fluent english, you should put "INSANE" as the extracted answer.
"""
