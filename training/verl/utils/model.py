...
def get_parallel_model_from_config(config, megatron_config, pp_layers, pre_process=None, post_process=None, share_embeddings_and_output_weights=False, value=False):
