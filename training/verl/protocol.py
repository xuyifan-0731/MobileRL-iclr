...
from typing import Callable, Dict, List, Optional, Union, Iterable, Sequence
...
class DataProto(Sequence):
    ...
    def chunk(self, chunks: int, balance_chunk: bool = True) -> List["DataProto"]:
        ...
        """
        if not self.is_padding_enabled() and balance_chunk:
