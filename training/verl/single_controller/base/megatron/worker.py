...
class MegatronWorker(Worker):
    ...
    def _init_hf_config_and_tf_config(
        ...
        tf_config.attention_backend = AttnBackend.flash
        ...
        def add_optimization_config_to_tf_config(tf_config):
            ...
            if self.config.model.get("enable_gradient_checkpointing", False):
                ...
                tf_config.recompute_granularity = gradient_checkpointing_cfg.get("activations_checkpoint_granularity", "uniform")
